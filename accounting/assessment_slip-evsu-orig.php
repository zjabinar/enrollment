...
echo '<div style="position:absolute; top:0.0cm; left:1.3in;"><img src="images/evsu_logo.jpg"></img></div>';
	echo '<div style="text-align:center">' . mkstr_capitalize($g_schoolname) . '</div>';
	//echo '<div style="text-align:center">' . mkstr_capitalize($g_schoolname_mid) . '</div>';
	...
	if ($curr_remarks<>"") {
		echo '<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:' . $size_x . '" class="payment">';
		echo '<tr><td>Remarks:&nbsp;&nbsp;' . $curr_remarks . '</td></tr>';
		echo '</table>';
	}
