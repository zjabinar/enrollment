...
<?php
	...
	echo '<div style="position:absolute; top:' . ($orig_y+82) . 'mm;left:' . ($orig_x+85) . 'mm;">' . mkstr_date($date) . '</div>';
	...
	echo '<div style="position:absolute; top:' . ($orig_y+82) . 'mm;left:' . ($orig_x+15) . 'mm;">' . $payor . " (" . mkstr_student_id($student_id) . ")" .'</div>';
